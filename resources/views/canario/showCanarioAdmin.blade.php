...
@section('contenido')
    <div class="container">
        <div class="menu">
            <ul>
                ...
                <li><a href="{{ route('criador.menu') }}" title="Botón Volver">Volver al menu de opciones</a></li>
            </ul>
    ...
    <h2>Mis canarios</h2>
    <div class="tarjetas-container" id="canarios-container"> <!-- Contenedor de resultados -->
