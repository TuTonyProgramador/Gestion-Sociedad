...
@section('contenido')
    ...
    <script>
        // Guardamos el HTML original de los criadores
            ...
            if (query !== '') {
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        // Actualizamos el contenido del contenedor de criadores con la respuesta del servidor
                        document.getElementById('criadores-container').innerHTML = xhr.responseText;
                    }
                };
                xhr.send();
            } else {
                // Si la consulta está vacía, restauramos los criadores originales
